...
## 팀 소개
<h3>24조(이름짓기귀찮조)</h3>
팀장 : 메타버스전문대학원 V2024624 도관목<br>
팀원 : 메타버스전문대학원 V2025111 이지나
...
5번을 실행해 학습을 진행합니다.<br>학습이 완료된 뒤, **reports 폴더에 학습 결과 그래프가 저장되고, models 폴더에 학습된 모델이 저장**됩니다.
